...
public class FragmentGame extends Fragment implements View.OnClickListener
{
    ...
    public void UpdateCards(String currentCard, String previousCard, int drinkCount, int cardCount)
    {
        ...
        ((TextView) view.findViewById(R.id.lblCount)).setText(String.valueOf(DrinkCount));
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
    {
        ...
        if (CurrentCard != null) {
            UpdateCards(CurrentCard, PreviousCard, DrinkCount, CardCount);
        } else {
